...
const bidSchema = new mongoose.Schema(
  {
    roomId: {
      type: String,
      required: true, // Ensures the roomId is always provided
    },
    freelancerName: {
      type: String,
      required: true, // Ensures freelancerName is provided
    },
    bidAmount: {
      type: Number,
      required: true, // Ensures bidAmount is provided and a number
    },
    milestone: {
      type: String,
      required: true, // Ensures milestone is provided
    },
    whyEligible: {
      type: String,
      required: true, // Ensures whyEligible is provided
    },
    createdAt: {
      type: Date,
